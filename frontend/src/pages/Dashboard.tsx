        ...
        <>
            ...
            {showEditorMobile && (
                <div className="md:hidden fixed inset-0 bg-gray-50 z-50 flex flex-col">
                    ...
                    {/* Mobile Editor Content - No Background Card */}
                    ...
                    <div className="bg-white shadow-md rounded-xl p-4">
                        ...
                        <div className="space-y-3 max-h-[75vh] overflow-y-auto pr-1">
                            {notes.map((note) => (
                                <div
                                    key={note._id}
                                    className={`flex justify-between items-center p-3 rounded-lg cursor-pointer border ${note._id === noteId ? 'bg-blue-50 border-blue-300' : 'hover:bg-gray-100'
                                        }`}
                                    onClick={() => handleSelectNote(note)}
                                >
